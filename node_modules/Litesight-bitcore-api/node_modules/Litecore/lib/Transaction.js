...
var SIGHASH_ALL = Transaction.SIGHASH_ALL = Script.SIGHASH_ALL;
var SIGHASH_NONE = Transaction.SIGHASH_NONE = Script.SIGHASH_NONE;
var SIGHASH_SINGLE = Transaction.SIGHASH_SINGLE = Script.SIGHASH_SINGLE;
var SIGHASH_ANYONECANPAY = Transaction.SIGHASH_ANYONECANPAY = Script.SIGHASH_ANYONECANPAY;
...
Transaction.prototype.fromObj = function fromObj(obj) {
  ...
  keys.forEach(function(addrStr) {
    ...
    var valueNum = BN(obj.outputs[addrStr]);
    var value = valueNum.toString(); //util.bigIntToValue(valueNum);
