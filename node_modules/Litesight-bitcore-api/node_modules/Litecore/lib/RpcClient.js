...
// Copyright 2024 Marscoin Foundation, LLC.
//
  ...
  var req = this.protocol.request(options, function(res) {
    ...
    res.on('end', function() {
      if (res.statusCode == 401) {
        callback(new Error('Marscoin JSON-RPC connection rejected: 401 unauthorized. Check our rpc username and password.'));
        return;
      }
      if (res.statusCode == 403) {
        callback(new Error('Marscoin JSON-RPC connection rejected: 403 forbidden'));
        return;
      }
